<%-- 
    Document   : AayamPreviousEvents
    Created on : Apr 26, 2021, 12:05:08 PM
    Author     : ASUS
--%>
...
<head>
    ...
    <title>Aayam-Previous Events</title>
...
<body>
    <div id="fh5co-offcanvas">
        ...
        <div class="fh5co-menu">
            <div class="fh5co-box">
                <ul>
                    <li><a href="AayamMainPage.jsp">Aayam</a></li>
                    <li><a href="AayamEvents.jsp">Events</a></li>
                </ul>
            </div>
        </div>
    </div>
