<%-- 
    Document   : CoronaEvents
    Created on : Apr 20, 2021, 4:40:33 PM
    Author     : ASUS
--%>
            ...
            <div class="container">
                <div class="row">
                    <%
                                 ...
                                 try
                                 {   
                                     String query="select * from events where club='corona' ";
                ...
                <div class="row">
                    <div class="main-menu">
                        <ul>
                            ...
                            <li>
                                <a href="CoronaPreviousEvents.jsp">Previous Events</a>
                            </li>
                            <li>
                                <a href="CoronaWinner.jsp">Winners</a>
                            </li>
                            <li>
                                <a href="coronaeventreg.jsp">Event Registration</a>
                            </li>
                        </ul>
