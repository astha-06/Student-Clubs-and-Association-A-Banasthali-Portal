<%-- 
    Document   : CoronaMainPage
    Created on : Apr 20, 2021, 10:57:18 AM
    Author     : ASUS
--%>
        ...
        <div id="video-container">
            ...
            <div class="video-content">
                <div class="inner">
                    <div class="regimg">
                        <center>
                            <img src="img/Corona Logo.jpg" class="circular--square" width="200" height="200" alt="">
                        </center>
                    </div>
                    <h1>Corona</h1>
            ...
            <video autoplay loop muted>
                <source src="videos/CoronaMainPageVideo.mp4" type="video/mp4" />
            </video>
        </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="portfolio-item">
                            <div class="thumb">
                                <a href="CoronaAboutUs.jsp"><img src="img/CoronaLP1.jpg"><div class="hover-effect">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="portfolio-item">
                            <div class="thumb">
                                <a href="CoronaEvents.jsp"><img src="img/CoronaLP2.jpg"><div class="hover-effect">
                                        <div class="hover-content">
                                            <h1>Events</h1>
                                        </div>
                                    </div></a>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="portfolio-item">
                            <div class="thumb">
                                <a href="CoronaWorkshops.jsp"><img src="img/CoronaLP3.jpg"><div class="hover-effect">
                                        <div class="hover-content">
                                            <h1>Workshops</h1>
                                        </div>
                                    </div></a>
                            ...
                            <div class="row">
                                <div class="main-menu">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="coronafeedbackqueries.jsp">Feedback/Queries</a>
                                        </li>
                                </div>
                            </div>
                        </div>
