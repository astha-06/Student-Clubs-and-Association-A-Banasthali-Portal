<%-- 
    Document   : CoronaWorkshops
    Created on : Apr 20, 2021, 4:55:56 PM
    Author     : ASUS
--%>
            ...
            <div class="container">
                <div class="row">
                    <%
                                    ...
                                    try
                                    {   
                                        String query="select * from workshops where club='corona' ";
            ...
            <div class="container">
                <div class="row">
                    <div class="main-menu">
                        <ul>
                            <li>
                                <a href="CoronaMainPage.jsp">Corona</a>
                            </li>
                            <li>
                                <a href="coronaworkshopreg.jsp">Workshop Registration</a>
                            </li>
                        </ul>
