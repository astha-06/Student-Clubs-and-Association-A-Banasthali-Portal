<%-- 
    Document   : SamarthyaEvents
    Created on : Apr 20, 2021, 7:08:51 PM
    Author     : ASUS
--%>
            ...
            <div class="container">
                <div class="row">
                    <%
                                 ...
                                 try
                                 {   
                                     String query="select * from events where club='samarthya' ";
            ...
            <div class="container">
                <div class="row">
                    <div class="main-menu">
                        <ul>
                            <li>
                                <a href="SamarthyaMainPage.jsp">Samarthya</a>
                            </li>
                            <li>
                                <a href="SamarthyaPreviousEvents.jsp">Previous Events</a>
                            </li>
                            <li>
                                <a href="SamarthyaWinner.jsp">Winners</a>
                            </li>
                            <li>
                                <a href="samarthyaeventreg.jsp">Event Registration</a>
                            </li>
                        </ul>
