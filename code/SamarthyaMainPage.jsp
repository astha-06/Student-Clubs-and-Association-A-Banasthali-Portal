<%-- 
    Document   : SamarthyaMainPage
    Created on : Apr 20, 2021, 6:47:09 PM
    Author     : ASUS
--%>
...
<html>
    <head>
        ...
        <title>Samarthya Main Page</title>
        ...
        <div id="video-container">
            ...
            <div class="video-content">
                <div class="inner">
                    <div class="regimg">
                        <center>
                            <img src="img/Samarthya Logo.jpeg" class="circular--square" width="200" height="200" alt="">
                        </center>
                    </div>
                    <h1>Samarthya</h1>
            ...
            <video autoplay loop muted>
                <source src="videos/SamarthyaMainPageVideo.mp4" type="video/mp4" />
            </video>
        </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="portfolio-item">
                            <div class="thumb">
                                <a href="SamarthyaAboutUs.jsp"><img src="img/SamarthyaLP1.jpg"><div class="hover-effect">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="portfolio-item">
                            <div class="thumb">
                                <a href="SamarthyaEvents.jsp"><img src="img/SamarthyaLP2.jpg"><div class="hover-effect">
                                        <div class="hover-content">
                                            <h1>Events</h1>
                                        </div>
                                    </div></a>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="portfolio-item">
                            <div class="thumb">
                                <a href="SamarthyaWorkshops.jsp"><img src="img/SamarthyaLP3.jpg"><div class="hover-effect">
                                        <div class="hover-content">
                                            <h1>Workshops</h1>
                                        </div>
                                    </div></a>
                            ...
                            <div class="row">
                                <div class="main-menu">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="samarthyafeedbackqueries.jsp">Feedback/Queries</a>
                                        </li>
                                </div>
                            </div>
                        </div>
