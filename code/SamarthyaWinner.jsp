...
<html>
    ...
    <ul>
        <nav >
            ...
            <li style="width: 120px"><a href="SamarthyaMainPage.jsp"><font size="4" color="white">Samarthya</font></a></li>
            <li style="width: 110px" ><a href="SamarthyaEvents.jsp"><font size="4" color="white">Home</font></a></li>
    ...
    <form action="view_winner_a.jsp" method="POST">
         <div class="regimg">
            ...
            <h2><font size="6">Samarthya</font></h2>
            <h2>WINNERS</h2>
         ...
         try
           {
               Class.forName("org.apache.derby.jdbc.ClientDriver");
                   ...
                   conn=DriverManager.getConnection("jdbc:derby://localhost:1527/Project","project","project");
                    ...
                    rs=st.executeQuery("Select * from winner Where event_by='samarthya' ");
                    while(rs.next())
                    {
            %>
            <tr bgcolor="white">
...
catch(Exception e)
{
 e.getMessage();
        ...
        <style>
            body{
                    background-image: url(https://images.unsplash.com/photo-1520624598504-ed830bd895d3?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80);
                    background-size:100%;
                }
                .container{
                    padding-top:50px;
