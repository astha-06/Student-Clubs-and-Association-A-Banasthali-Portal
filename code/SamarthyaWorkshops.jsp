<%-- 
    Document   : SamarthyaWorkshops
    Created on : Apr 20, 2021, 7:39:00 PM
    Author     : ASUS
--%>
...
<html>
    <head>
        ...
        <title>Samarthya-Workshops</title>
        ...
        <div class="container">
            <div class="row">
                <%
                                ...
                                try
                                {   
                                    String query="select * from workshops where club='samarthya' ";
                                    ...
                                    ResultSet rs=st.executeQuery(query);
                                         ...
                                         while(rs.next())
                                        {
                                             ...
                                             String enam = rs.getString("work_name");
                                             String dat = rs.getString("work_date"); 
                                            out.print("<tr>");
        ...
        <div class="row">
          <div class="main-menu">
              <ul>
                  ...
                  <li>
                      <a href="samarthyaworkshopreg.jsp">Workshop Registration</a>
                  </li>
              </ul>
