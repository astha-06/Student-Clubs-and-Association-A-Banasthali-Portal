...
<html>
    <head>
        ...
        <title>View Queries(Corona)</title>
    </head>
    ...
    <body>
        ...
        <ul>
            <nav >
                ...
                <li style="width: 110px" ><a href="coronafeedbackqueries.jsp"><font size="4" color="white">Back</font></a></li>
        ...
        <div class="container">
            <form  method="post" action="ViewQueryCorona.jsp"  class="form-horizontal" role="form">
                <div class="regimg">
                    <center>
