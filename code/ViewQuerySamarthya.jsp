...
<html>
    <head>
        ...
        <title>View Queries(Samarthya)</title>
    </head>
    ...
    <body>
        ...
        <ul>
            <nav >
                ...
                <li style="width: 110px" ><a href="samarthyafeedbackqueries.jsp"><font size="4" color="white">Back</font></a></li>
        ...
        <div class="container">
            <form  method="post" action="ViewQuerySamarthya.jsp"  class="form-horizontal" role="form">
               <div class="regimg">
                    <center>
                    ...
                    <div class="col-sm-6">
                        <select style="width:auto" name="email" class="form-control" autofocus>
                            <%
                                ...
                                try
                                {   
                                    String query="select email from query where club='samarthya' ";
