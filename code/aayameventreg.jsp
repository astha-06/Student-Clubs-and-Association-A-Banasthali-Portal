...
<html>
    <head>
        ...
        <title>Aayam Event Registration</title>
    </head>
    <body>
        <style>
            body{
        ...
        <ul>
            <nav >
                ...
                <li style="width: 120px"><a href="AayamEvents.jsp"><font size="4" color="white">Events</font></a></li>
        ...
        <div class="container">
            <form  method="post" action="aayameventreg.jsp"  class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="eventby" name="event_by" placeholder="Aayam" class="form-control" autofocus disabled>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="ename" class="form-control" autofocus required>
                            <%
                                ...
                                try
                                {   
                                    String query="select event_name from events where club='aayam' ";
