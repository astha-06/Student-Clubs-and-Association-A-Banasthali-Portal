...
<html>
    <head>
        ...
        <title>Aayam Feedback/Queries</title>
    </head>
    <body>
        <style>
            body{
        ...
        <ul>
            <nav >
                ...
                <li style="width: 120px" ><a href="ViewQueryAayam.jsp"><font size="4" color="white" text-center>View Queries</font></a></li>
                <li style="width: 110px" ><a href="AayamMainPage.jsp"><font size="4" color="white">Aayam</font></a></li>
                <li style="width: 100px" ><a href="HomepageHome.jsp"><font size="4" color="white" text-center>Home</font></a></li>
        ...
        <div class="container">
            <form  method="post" action="aayamfeedbackqueries.jsp"  class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="feedbackfor" name="club" placeholder="Aayam" class="form-control" autofocus disabled>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="container">
            <form  method="post" action="aayamfeedbackqueries.jsp"  class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="feedbackfor" name="club1" placeholder="Aayam" class="form-control" autofocus disabled>
                    </div>
                </div>
                <div class="form-group">
