...
<html>
    <head>
        ...
        <title>Delete Events(Corona)</title>
    </head>
    <body>
        <style>
            body{
                background-size: 100%;
                background-image:  url(https://images.unsplash.com/photo-1572557798994-41431698dc8d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1868&q=80);    
            }
            .circular--square {
                border-radius: 50%;
            }
        ...
        <div class="container">
            <form  method="post" action="delete_event_c.jsp"  class="form-horizontal" role="form">
                                        ...
                                        if (request.getParameter("btn_del")!= null)
                                         {
                                                ...
                                                pstmt = conn2.prepareStatement("delete from events where event_name=('"+en+"')");
