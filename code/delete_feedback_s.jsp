<%-- 
    Document   : delete_query_a
    Created on : 28 Apr, 2021, 2:53:46 PM
    Author     : Hp
--%>
...
<html>
    <head>
        ...
        <title>Delete Feedback(Samarthya)</title>
    </head>
    <body>
        <style>
            body{
                background-size: 100%;
                background-image:  url(https://images.unsplash.com/photo-1547985510-593e2bdb0094?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80);    
            }
            .circular--square {
                border-radius: 50%;
            }
        ...
        <div class="container">
            <form  method="post" action="delete_feedback_s.jsp"  class="form-horizontal" role="form">
                <h2><font size="6" color="#7d5a69">Samarthya Admin Panel</font></h2>
                <h2>Delete Feedback</h2>
                <div class="form-group">
                    <label for="workby" class="col-sm-5 control-label"> Choose email of students you want to delete feedback of</label>
                    <div class="col-sm-6">
                        <select name="email" class="form-control" autofocus>
                            <%
                                ...
                                try
                                {   
                                    String query="select email from feedback where club='samarthya' ";
                ...
                catch(Exception e)
                {
                    ...
                    e.printStackTrace();
                        ...
                        <br>
                        <div class="col-sm-6">
                            <input type="submit" name="btnver" value="View" class="btn btn-primary btn-block" onclick="formProcess()" />
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <table class="table table-bordered table-striped" align="center" width="30%">
                                   ...
                                   try
                                    {
                                        ...
                                        String query= "Select email,club,feed from feedback where email='" + email + "' ";
                                ...
                                %>
                                <script>
                                    swal("Feedback  shown ", "Hit Delete button", "success");
                                </script>
                                <%
                 }
                 else{
                    ...
                    if (request.getParameter("btn_del")!= null)
                     {
                            ...
                            pstmt = conn2.prepareStatement("delete from feedback where email=('"+en+"')");
