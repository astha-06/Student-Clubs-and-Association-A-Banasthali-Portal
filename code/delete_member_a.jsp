...
<html>
    <head>
        ...
        <title>Delete Members(Aayam)</title>
    </head>
    <body>
        <style>
            body{
        ...
        <div class="container">
            <form  method="post" action="delete_member_a.jsp"  class="form-horizontal" role="form">
                    ...
                    <div class="col-sm-6">
                        <select name="email" class="form-control" autofocus>
                            <%
                                ...
                                try
                                {   
                                    String query="select email from members where club='aayam' ";
