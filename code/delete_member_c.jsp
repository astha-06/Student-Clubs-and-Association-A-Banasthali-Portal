...
<html>
    <head>
        ...
        <title>Delete Members(Corona)</title>
    </head>
    <body>
        <style>
            body{
        ...
        <div class="container">
            <form  method="post" action="delete_member_c.jsp"  class="form-horizontal" role="form">
                    ...
                    <div class="col-sm-6">
                        <select name="email" class="form-control" autofocus>
                            <%
                                ...
                                try
                                {   
                                    String query="select email from members where club='corona' ";
