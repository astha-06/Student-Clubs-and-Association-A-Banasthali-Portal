<%-- 
    Document   : delete_member_a
    Created on : 27 Apr, 2021, 12:58:18 PM
    Author     : Hp
--%>
...
<html>
    <head>
        ...
        <title>Delete Members(Samarthya)</title>
    </head>
    <body>
        <style>
           body{
                background-size: 100%;
                background-image:  url(https://images.unsplash.com/photo-1517539551794-2c182198bb24?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80);    
            }
            .circular--square {
                border-radius: 50%;
            }
        ...
        <div class="container">
            <form  method="post" action="delete_member_s.jsp"  class="form-horizontal" role="form">
                <h2><font size="6" color="#7d5a69">Samarthya Admin Panel</font></h2>
                <h2>Delete Members </h2>
                <div class="form-group">
                    <label for="workby" class="col-sm-5 control-label"> Choose email of member you want to delete</label>
                    <div class="col-sm-6">
                        <select name="email" class="form-control" autofocus>
                            <%
                                ...
                                try
                                {   
                                    String query="select email from members where club='samarthya' ";
                ...
                catch(Exception e)
                {
                    ...
                    e.printStackTrace();
                        ...
                        <br>
                        <div class="col-sm-6">
                            <input type="submit" name="btnver" value="Verify" class="btn btn-primary btn-block" onclick="formProcess()" />
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <table class="table table-bordered table-striped" align="center" width="30%">
                                ...
                                %>
                                <script>
                                    swal("Verified", "Hit Delete button", "success");
                                </script>
                                <%
                 }
                 else{
                    ...
                    if (request.getParameter("btn_del")!= null)
                     {
                            ...
                            pstmt = conn2.prepareStatement("delete from members where email=('"+en+"')");
