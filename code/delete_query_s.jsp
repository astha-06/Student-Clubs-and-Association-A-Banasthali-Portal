<%-- 
    Document   : delete_query_s
    Created on : 28 Apr, 2021, 2:54:17 PM
    Author     : Hp
--%>
...
<html>
    <head>
        ...
        <title>Delete Queries(Samarthya)</title>
    </head>
    <body>
        <style>
             body{
        ...
        <div class="container">
            <form  method="post" action="delete_query_s.jsp"  class="form-horizontal" role="form">
