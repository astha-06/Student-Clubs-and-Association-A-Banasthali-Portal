...
<html>
    <head>
        ...
        <title>Delete Winners(Corona)</title>
    </head>
    <body>
        <style>
          body{
                background-size: 100%;
                background-image:  url(https://images.unsplash.com/photo-1584381296550-99dfc0837d42?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80);    
            }
            .circular--square {
                border-radius: 50%;
            }
        ...
        <div class="container">
            <form  method="post" action="delete_winner_c.jsp"  class="form-horizontal" role="form">
                <h2><font size="6" color="#7d5a69">Corona Admin Panel</font></h2>
                <h2>Delete Winners </h2>
                <div class="form-group">
                    <label for="workby" class="col-sm-5 control-label"> Choose Event you want to delete the winners of</label>
                    <div class="col-sm-7">
                    ...
                    if (request.getParameter("btn_del")!= null)
                     {
                            ...
                            pstmt = conn2.prepareStatement("delete from winner where event_name=('"+en+"')");
