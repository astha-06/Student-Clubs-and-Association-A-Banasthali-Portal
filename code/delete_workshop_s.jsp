...
<html>
    <head>
        ...
        <title>Delete Workshops(Samarthya)</title>
    </head>
    <body>
        <style>
            body{
        ...
        <div class="container">
            <form  method="post" action="delete_workshop_s.jsp"  class="form-horizontal" role="form">
                <h2><font size="6" color="#7d5a69">Samarthya Admin Panel</font></h2>
                <h2>Delete Workshop </h2>
                <div class="form-group">
                    <label for="workby" class="col-sm-5 control-label"> Choose Workshop you want to delete</label>
                    <div class="col-sm-7">
