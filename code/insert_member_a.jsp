...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form  method="post" action="insert_member_a.jsp"  class="form-horizontal" role="form" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="eventby" name="eve_by" placeholder="Aayam" class="form-control" autofocus disabled>
                    </div>
                </div>
