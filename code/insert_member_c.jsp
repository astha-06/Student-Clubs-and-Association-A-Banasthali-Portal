...
<html>
    <head>
        ...
        <title>Insert Members(Corona)</title>
    ...
    <body>
        ...
        <div class="container">
            <form  method="post" action="insert_member_c.jsp"  class="form-horizontal" role="form" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="email" id="name" name="email" placeholder="Email" class="form-control" autofocus >
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="eventby" name="eve_by" placeholder="Corona" class="form-control" autofocus disabled>
                    </div>
                </div>
