...
<html>
    <head>
        ...
        <title>Insert Winners(Corona)</title>
    </head>
    ...
    <body>
        ...
        <div class="container">
            <form  method="post" action="insert_winner_c.jsp"  class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="ename" name="eveby" placeholder="Corona" class="form-control" autofocus disabled>
                    </div>
                </div>
                <div class="form-group">
