...
<html>
    <head>
        ...
        <title>Insert Workshops(Samarthya)</title>
    ...
    <body>
        <style>
            body{
                background-size: 100%;
                background-image:  url(https://images.unsplash.com/photo-1573519716358-1cdc98533bfa?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1868&q=80);    
            }
            .circular--square {
                border-radius: 50%;
            }
        ...
        <div class="container">
            <form  method="post" action="FileUploadWorkshop"  class="form-horizontal" enctype="multipart/form-data" role="form">
