...
<html>
    <head>
        ...
        <title>Samarthya Event Registration</title>
    </head>
    <body>
        <style>
            body{
                background-size: 100%;
                background-image:  url(https://images.unsplash.com/photo-1584381296550-99dfc0837d42?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80);         
            }
            .circular--square {
                border-radius: 50%;
            }
        ...
        <ul>
            <nav >
                ...
                <li style="width: 120px"><a href="SamarthyaEvents.jsp"><font size="4" color="white">Events</font></a></li>
                <li style="width: 110px" ><a href="SamarthyaMainPage.jsp"><font size="4" color="white">Samarthya</font></a></li>
        ...
        <div class="container">
            <form  method="post" action="samarthyaeventreg.jsp"  class="form-horizontal" role="form">
                <h2><font size="6" color="#7d5a69">Samarthya</font></h2>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="eventby" name="event_by" placeholder="Samarthya" class="form-control" autofocus disabled>
                    </div>
                </div>
                <div class="form-group">
                    <label for="wokrName" class="col-sm-3 control-label">Event Name</label>
                    <div class="col-sm-9">
                        <select name="ename" class="form-control" autofocus required>
                            <%
       ...
       {            
                     ...
                     if (request.getParameter("btnreg")!= null)
                     {
                        ...
                        while(rs.next())
                        {
                            ...
                            String wn=request.getParameter("ename");
                            ...
                            int y = st.executeUpdate("insert into event_reg values('"+club+"','"+wn+"','"+s+"','"+e+"','"+c+"',"+yr+","+p+")");
                           if(y>0)
                               {
%>
<script>
