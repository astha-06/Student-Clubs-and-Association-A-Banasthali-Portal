...
<html>
    <head>
        ...
        <title>Samarthya Feedback/Queries</title>
    </head>
    <body>
        <style>
            body{
        ...
        <ul>
            <nav >
                ...
                <li style="width: 120px" ><a href="ViewQuerySamarthya.jsp"><font size="3" color="white" text-center>View Queries</font></a></li>
                <li style="width: 110px" ><a href="SamarthyaMainPage.jsp"><font size="3" color="white">Samarthya</font></a></li>
        ...
        <div class="container">
            <form  method="post" action="samarthyafeedbackqueries.jsp"  class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="feedbackfor" name="club" placeholder="Samarthya" class="form-control" autofocus disabled>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="container">
            <form  method="post" action="samarthyafeedbackqueries.jsp"  class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="feedbackfor" name="club1" placeholder="Samarthya" class="form-control" autofocus disabled>
                    </div>
                </div>
