...
<html>
    <head>
        ...
        <title>Update Events(Samarthya)</title>
    ...
    <body>
        <style>
            body{
                background-size: 100%;
                background-image:  url(https://images.unsplash.com/photo-1566026723606-8ee2b0a0b0d4?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1934&q=80);    
            }
            .circular--square {
                border-radius: 50%;
            }
        ...
        <div class="container">
            <form  method="post" action="FileUpdateEvent"  class="form-horizontal" enctype="multipart/form-data" role="form">
                <h2><font size="6" color="#7d5a69">Samarthya Admin Panel</font></h2>
                <h2>Update Events</h2>
                <div class="form-group">
                    <label for="workby" class="col-sm-3 control-label">Event name to update</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="cname" name="cname"  value="samarthya" class="form-control" autofocus >
                    </div>
                </div>
                <div class="form-group">
                ...
                <p align="center">
                    <input  type="Submit" value="Update" name="btn_up" />
