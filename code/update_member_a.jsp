...
<html>
    <head>
        ...
        <title>Update Members(Aayam)</title>
    </head>
    ...
    <body>
        ...
        <div class="container">
            <form  method="post" action="update_member_a.jsp"  class="form-horizontal" role="form">
       ...
       {  
           ...
           String p=request.getParameter("phno");
                    ...
                    if (request.getParameter("btn_up")!= null)
                     {
                          String query="update members set s_name='"+s+"',email='"+m+"',course='"+c+"',current_year="+y+",ph_number="+p+",club='aayam' where email='"+m+"' ";
