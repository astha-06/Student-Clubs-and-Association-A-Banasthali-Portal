...
<html>
    <head>
        ...
        <title>View Events(Samarthya)</title>
    </head>
    <body>        
    </body>
    <ul>
    ...
    <form action="view_event_s.jsp" method="POST">
        <table border="4" align="center" style="width:50%">
            ...
            <style>
                body{
                    background-image: url(https://images.unsplash.com/photo-1515895309288-a3815ab7cf81?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80);
                    background-size:100%;
                }
                .container{
                    padding-top:50px;
     ...
     try
       {
           Class.forName("org.apache.derby.jdbc.ClientDriver");
               ...
               conn=DriverManager.getConnection("jdbc:derby://localhost:1527/Project","project","project");
                ...
                rs=st.executeQuery("Select * from events Where club='samarthya' ");
                while(rs.next())
                {
                    out.print("<tr>");
