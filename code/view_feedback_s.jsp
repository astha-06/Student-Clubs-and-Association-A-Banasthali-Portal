...
<html>
    <head>
        ...
        <title>View Feedback(Samarthya)</title>
    </head>
    <body>        
    </body>
    <ul>
    ...
    <h2>View Feedback</h2>
    <form action="view_feedback_s.jsp" method="POST">
         ...
         try
           {
               Class.forName("org.apache.derby.jdbc.ClientDriver");
                   ...
                   conn=DriverManager.getConnection("jdbc:derby://localhost:1527/Project","project","project");
                    ...
                    rs=st.executeQuery("Select * from feedback Where club='samarthya' ");
                    while(rs.next())
                    {
            %>
            <tr bgcolor="#ffffff">
